...
export const GridPointView = joint.dia.ElementView.extend({
  ...
  render() {
    ...
    topLine.setAttribute('y2', String(gfxH * 0.08))
    ...
    topTerm.setAttribute('class', 'grid-terminal')
    ...
    botTerm.setAttribute('class', 'grid-terminal')
