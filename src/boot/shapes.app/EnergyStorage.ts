...
export const EnergyStorageView = joint.dia.ElementView.extend({
  ...
  render() {
    ...
    topTerm.setAttribute('class', 'es-terminal')
    ...
    botLine.setAttribute('class', 'es-line')
    ...
    botTerm.setAttribute('class', 'es-terminal')
